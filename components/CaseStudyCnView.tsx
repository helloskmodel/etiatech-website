        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_300px] lg:px-8">
          <article className="max-w-3xl">
            ...
            <section className="border-t border-gray-100 py-9">
              <p className="mb-2 text-xs font-bold uppercase tracking-widest text-[#44B549]">{t({ en: "04 · Recommended System", zh: "04 · 推荐系统", th: "04 · ระบบที่แนะนำ", vi: "04 · Hệ thống đề xuất" }, locale)}</p>
            ...
            <section className="border-t border-gray-100 py-9">
              <p className="mb-2 text-xs font-bold uppercase tracking-widest text-[#44B549]">{t({ en: "05 · Benefits", zh: "05 · 应用收益", th: "05 · ประโยชน์ที่ได้รับ", vi: "05 · Lợi ích" }, locale)}</p>
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              <p className="text-xs font-bold uppercase tracking-widest text-[#44B549]">{t({ en: "Recommended System", zh: "推荐系统", th: "ระบบที่แนะนำ", vi: "Hệ thống đề xuất" }, locale)}</p>
