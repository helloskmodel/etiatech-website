...
const zhDict: Record<string, string> = {
  ...
  "MICROWAVE UV CURING SYSTEMS": "微波UV光固化系统",
  ...
  "Clean & Safe": "清洁与安全",
  "Precision": "精准",
  "UV curing converts liquid formulations to solid materials in seconds — eliminating thermal ovens, long cure queues, and handling delays that slow production lines.": "UV光固化在数秒内将液态配方转化为固体材料——免去热风烤箱、漫长固化排队及拖慢产线的搬运延迟。",
  "UV curable materials are 100% solid with no solvents — zero VOC emissions, no hazardous waste disposal, and no fumes in the clean room.": "UV光固化材料100%固含、无溶剂——零VOC排放、无危废处理、洁净室内无烟雾。",
  ...
  "UV curing is a photochemical process that converts liquid formulations — adhesives, coatings, inks — into fully solid materials instantly when exposed to high-intensity UV energy.": "UV光固化是一种光化学过程，在高强度UV能量照射下，将胶粘剂、涂层、油墨等液态配方瞬间转化为完全固化的固体材料。",
};
        ...
        items: [
          {
            ...
            models: ["Nexus II", "FireLine FL200", "FireLine FL400", "FireLine FL400-i Industrial", "FireLine FL440", "VeriCure Water-Cooled"],
            bg: "#0d9488",
          },
        ],
      },
        ...
        items: [
          {
            ...
            models: ["Nexus II Air-Cooled", "FireJet ONE", "FireJet FJ100", "FireJet FJ240", "FireJet FJ800", "FireJet FJ801"],
            bg: "#1A56DB",
          },
          {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl text-left">
            ...
            <p className="text-base text-gray-200 mb-6 leading-relaxed">
              {t({ en: "OmniCure · Phoseon · Fusion UV · NobleLight — matched to your exact application by engineers with 20 years of field validation.", zh: "OmniCure · Phoseon · Fusion UV · NobleLight —— 由拥有20年经验的工程师，为您的具体应用精准匹配UV 光固化方案。" }, locale)}
            </p>
      ...
      <section className="py-20" style={{ background: "#f0f4f8" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-semibold tracking-widest uppercase mb-2" style={{ color: "#44B549" }}>{t({ en: "UV Curing Technology", zh: "UV光固化技术" }, locale)}</p>
          <h2 className="text-3xl font-bold mb-4" style={{ color: "#1A56DB" }}>{t({ en: "Why UV Curing?", zh: "为何选择UV光固化?" }, locale)}</h2>
      ...
      <section className="py-16" style={{ background: "#1A56DB" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8">{t({ en: "Our engineers will match the right UV curing system to your exact application — from selection to validation.", zh: "我们的工程师将为您的具体应用匹配合适的UV光固化系统——从选型到验证。" }, locale)}</p>
