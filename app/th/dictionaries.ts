...
const tri = {
  metaTitle: {
    ...
    zh: "OmniCure 泰国授权分销商 — UV 光固化系统 | ETIA",
  } as Tri,
  metaDescription: {
  ...
  ctaBody: {
    ...
    zh: "我们的工程师将为您的具体应用匹配合适的 UV 光固化系统——从选型到验证。",
  } as Tri,
  ...
  footerTagline: {
    ...
    zh: "世界级 UV 光固化系统授权代理，20 年应用专业经验，覆盖 10 大行业。",
  } as Tri,
  footerRights: {
    th: "สงวนลิขสิทธิ์",
...
const homeTri = {
  ...
  heroSubtitle: {
    ...
    zh: "ETIA将20年UV光固化实战经验，转化为覆盖选型、工艺验证、故障排查、保养与自有维修的全方位实用支持。",
  } as Tri,
  ...
  whyIntro: {
    ...
    zh: "立足硬核工程技术，携手全球头部 UV 光固化品牌，提供经过市场验证、性能稳定、全流程保障的一体化方案，从设备选型到终身售后全程护航。",
  } as Tri,
  spectrumEyebrow: { th: "เทคโนโลยี UV Curing", en: "UV Curing Technology", zh: "UV光固化技术" } as Tri,
  spectrumHeading: {
  ...
  casesSubtitle: {
    ...
    zh: "看我们的UV光固化系统如何在最看重精度与可靠性的场景中交付成果。",
  } as Tri,
