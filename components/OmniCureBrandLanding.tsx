    ...
    <div className="bg-white text-[#14213D]">
      ...
      <section className="bg-gradient-to-r from-[#143C96] to-[#1F63D6] px-4 py-5 text-white sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 text-center md:flex-row md:justify-between md:text-left">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-xs font-semibold text-blue-100">{[{ en: "Genuine Products", zh: "正品保障", th: "รับประกันสินค้าของแท้", vi: "Sản phẩm chính hãng" }, { en: "Application-Driven Solution", zh: "应用驱动", th: "โซลูชันที่ออกแบบตามการใช้งาน", vi: "Giải pháp theo ứng dụng" }, { en: "Local Supply Chain", zh: "本地供应", th: "ห่วงโซ่อุปทานในประเทศ", vi: "Chuỗi cung ứng địa phương" }, { en: "Long-Term Service", zh: "长期服务", th: "บริการระยะยาว", vi: "Dịch vụ dài hạn" }].map((item) => <span key={item.en} className="inline-flex items-center gap-1.5"><BadgeCheck className="h-4 w-4 text-[#8BE172]" />{t(item, locale)}</span>)}</div>
