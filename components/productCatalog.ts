...
export const productTagline: Record<string, { en: string; zh: string; vi?: string; th?: string }> = {
  "s2000-elite": { en: "The Most Reliable, Highest-Quality Lamp Spot Curing", zh: "高可靠、高品质的灯式点固化", vi: "Lamp Spot Curing đáng tin cậy nhất, chất lượng cao nhất", th: "Lamp Spot Curing ที่เชื่อถือได้ที่สุดและคุณภาพสูงสุด" },
...
export const productHighlights: Record<string, LangText[]> = {
  ...
  "v3-led-heads": [{ en: "Class-Leading Output", zh: "强劲输出", th: "เอาต์พุตชั้นนำ", vi: "Đầu ra dẫn đầu" }, { en: "Uniform Beam Profile", zh: "均匀光束分布", th: "โปรไฟล์ลำแสงสม่ำเสมอ", vi: "Chùm tia đồng đều" }, { en: "Multi-Wavelength", zh: "多波长", th: "หลายความยาวคลื่น", vi: "Đa bước sóng" }],
  ...
  "ac8-hd": [{ en: "Double the Dose", zh: "双倍剂量", th: "โดสสองเท่า", vi: "Liều gấp đôi" }, { en: "Highest UV Energy", zh: "高紫外能量", th: "พลังงาน UV สูงสุด", vi: "Năng lượng UV cao nhất" }, { en: "Adjoinable", zh: "可拼接", th: "ต่อขยายได้", vi: "Ghép nối được" }],
