          ...
          <div className="mx-auto max-w-5xl">
            ...
            {c.selectionGuide.table && (
              <figure className="mt-12">
                  ...
                  <table className="w-full min-w-[44rem] border-collapse text-left text-sm">
                    <thead>
                      <tr className="border-b border-[#D9E4EA] bg-[#F7FAFC]">
                        {c.selectionGuide.table.columns.map((col, i) => (
                    ...
                    <tbody>
                      {c.selectionGuide.table.rows.map((row, i) => (
                ...
                {c.selectionGuide.table.footnote && (
                  <p className="mt-3 text-xs leading-5 text-[#98A2B3]">{t(c.selectionGuide.table.footnote, locale)}</p>
                )}
              </figure>
            )}
          </div>
