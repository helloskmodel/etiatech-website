      ...
      {fields.map((f) => (
        <div key={f}>
          ...
          <select className="w-full px-3 py-2 rounded-lg border border-gray-200 bg-white text-gray-600 text-sm focus:outline-none focus:border-[#1A56DB]">
            ...
            {f === "Industry" && ["Medical Device", "Automotive", "Electronics & Semiconductor", "Optical Fiber & Cable", "Optics & Optical Assembly", "UV Printing", "Wood Coatings", "Metal Coatings", "Aerospace", "Photonics & Advanced Packaging", "Other"].map((o) => <option key={o}>{o}</option>)}
