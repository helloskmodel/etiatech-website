...
export const products: Product[] = [
  ...
  // curing equipment — hence their own technology category.
  {
    ...
    features: [
      ...
      "Cyclic operation extends service life to as much as three years",
    ...
    specs: [
      ["Type", "FiberLight® D2 Basic — integrated UV-Vis light source module"],
      ["Power", "6 W"],
      ["Spectral Range", "185–1100 nm (extendable to 160 nm)"],
      ["Lamps", "Deuterium + tungsten, in one optical system"],
      ["Included", "Shutter, optical system, SMA 905 connector, all on one PCB"],
      ["Control", "Lamps and shutter individually switched by TTL signal"],
      ["Lamp Technology", "Electrodeless discharge lamp (EDL)"],
