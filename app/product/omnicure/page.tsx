    ...
    <>
      ...
      <section className="py-12 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0a1628 0%, #0f2444 100%)" }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-base text-gray-300 max-w-2xl mb-6 leading-relaxed line-clamp-2">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <a href="mailto:mark_tang@etia-tech.com?subject=Engineering%20Inquiry" className="px-6 py-3 rounded font-semibold text-white border border-white/30 hover:border-white/60 transition-all">Talk to Engineers</a>
          </div>
      ...
      <section id="products" className="py-20" style={{ background: "#f0f4f8" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            ...
            <a href="mailto:mark_tang@etia-tech.com?subject=Engineering%20Inquiry" className="hover:underline font-medium" style={{ color: "#1A56DB" }}>Talk to ETIA Engineers →</a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16" style={{ background: "#1A56DB" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <a href="mailto:mark_tang@etia-tech.com?subject=Engineering%20Inquiry" className="px-8 py-3 rounded font-semibold text-white hover:opacity-90" style={{ background: "#44B549" }}>Talk to ETIA Engineers →</a>
        </div>
      </section>
    </>
  );
