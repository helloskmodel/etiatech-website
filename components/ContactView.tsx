    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-[#D9E4EA] bg-gradient-to-br from-white via-[#EEF6FF] to-[#F1FAEF]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24 lg:px-8">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#41A62A]/20 bg-white px-3 py-1.5 text-xs font-bold text-[#41A62A] shadow-sm"><BadgeCheck className="h-4 w-4" /> {t({ en: "Service & Support", zh: "销售与支持", th: "ฝ่ายขายและบริการ", vi: "Kinh doanh & hỗ trợ" }, locale)}</div>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="overflow-hidden rounded-[32px] bg-gradient-to-br from-[#143C96] to-[#1A56DB] px-6 py-14 text-center text-white sm:px-10">
            ...
            <p className="mx-auto mt-5 max-w-3xl leading-7 text-blue-100">{t({ en: "Tell us your application, adhesive, curing area, wavelength, and production requirements. ETIA engineers help you select, implement, and maintain the right UV curing system — with local support across Thailand, Vietnam and Southeast Asia.", zh: "告诉我们您的应用、胶粘剂、固化面积、波长与生产需求。ETIA 工程师协助您选型、导入并维护合适的 UV Curing 紫外线固化系统——并在泰国、越南与东南亚提供本地支持。", th: "บอกเราเกี่ยวกับการใช้งาน กาว พื้นที่คิวริ่ง ความยาวคลื่น และความต้องการด้านการผลิตของคุณ วิศวกร ETIA ช่วยคุณเลือก ติดตั้ง และดูแลระบบ UV Curing ที่เหมาะสม พร้อมการสนับสนุนในพื้นที่ทั่วไทย เวียดนาม และเอเชียตะวันออกเฉียงใต้", vi: "Cho chúng tôi biết ứng dụng, keo, diện tích đóng rắn, bước sóng và yêu cầu sản xuất của bạn. Kỹ sư ETIA giúp bạn chọn, triển khai và bảo trì hệ thống UV curing phù hợp — với hỗ trợ tại chỗ trên khắp Thái Lan, Việt Nam và Đông Nam Á." }, locale)}</p>
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a href="#inquiries" className="inline-flex items-center justify-center rounded-xl bg-[#41A62A] px-7 py-3.5 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#3A9D3F]">{t({ en: "Send an Inquiry", zh: "发送咨询", th: "ส่งคำสอบถาม", vi: "Gửi yêu cầu" }, locale)}</a>
