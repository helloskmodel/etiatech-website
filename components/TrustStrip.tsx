...
const TRUST_ITEMS = ["Authorized Supply", "Genuine Equipment", "Local Stock", "Application Engineering", "Repair Support"];

export default function TrustStrip() {
  return (
    <section className="bg-gradient-to-r from-[#143C96] to-[#1F63D6] px-4 py-5 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-3 text-center text-xs font-bold sm:grid-cols-5 sm:text-sm">
