        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 rounded-2xl p-6 text-center" style={{ background: "#1A56DB" }}>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <a href={inquiryHref(locale, { subject: "Sales Inquiry", context: note.title })} className="px-6 py-2.5 rounded font-semibold text-white hover:opacity-90 transition-all" style={{ background: "#41A62A" }}>{t({ en: "Talk to Our Sales →", zh: "联系我们的销售 →" }, locale)}</a>
