...
export const whyEtia: { Icon: typeof FlaskConical; title: LangText; desc: LangText }[] = [
  ...
  {
    Icon: Package,
    title: { en: "Local Supply & Fast Delivery", zh: "本地备货 · 快速交付" , vi: "Cung ứng địa phương & giao hàng nhanh" },
    desc: {
  ...
  {
    Icon: Wrench,
    title: { en: "In-House Repair Factory", zh: "自有维修工厂" , vi: "Xưởng sửa chữa nội bộ" },
    desc: {
  ...
  {
    Icon: ClipboardCheck,
    title: { en: "Full-Process Consulting Service", zh: "全流程咨询服务" , vi: "Dịch vụ tư vấn toàn quy trình" },
    desc: {
