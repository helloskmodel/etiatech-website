...
const tagZh: Record<string, string> = {
  ...
  "Microwave UV Curing": "微波 UV Curing 光固化",
};
    ...
    <>
          ...
          <div className="max-w-3xl">
            ...
            <h1 className={`text-3xl md:text-5xl font-bold leading-tight text-white ${b.hero ? "mb-4" : "mb-6"}`}>
              {b.hero
                ...
                : `${b.name.replace(/ UV$/, "")} ${t({ en: "UV Curing Systems", zh: "UV Curing 光固化系统" }, locale)}`}
            </h1>
            {b.hero && (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-2xl md:text-3xl font-bold mb-2" style={{ color: "#1A56DB" }}>{t({ en: slug === "omnicure" ? "OmniCure UV Curing Product Catalog" : `Shop ${b.name} Systems`, zh: slug === "omnicure" ? "OmniCure UV Curing 光固化产品清单" : `${b.name} 全系产品` }, locale)}</h2>
      ...
      <section className="py-14" style={{ background: "#1A56DB" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8">{t({ en: "Our UV curing engineers will match the right configuration to your process — from selection to validation.", zh: "我们的 UV Curing 光固化工程师将为您的工艺匹配合适的配置——从选型到验证。" }, locale)}</p>
