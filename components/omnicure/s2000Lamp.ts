...
export const LAMP = {
  name: "OmniCure S2000 / S2000 Elite Lamp",
  ...
  heroAlt: "Omnicure S2000 lamp 012-64000R and S2000 Elite lamp module 012-68000R, 200W UV curing",
  ...
  lifeAlt: "Omnicure S2000 spare 200W lamp 012-65000R long service life",
  stats: [
  ...
  parts: [
    ...
    ["012-64000R", "S2000 Replacement Lamp – Standard (200 W)"],
    ["012-65000R", "S2000 Replacement Lamp – Surface Cure (200 W)"],
  ] as [string, string][],
  lampTypes: [
    {
      name: "Standard",
      pn: "S2000 Elite 012-68000R · S2000 012-64000R",
      desc: {
    ...
    {
      name: "Surface Cure",
      pn: "S2000 Elite 012-69000R · S2000 012-65000R",
      desc: {
...
const CONTENT: Record<LampLang, { h1: string; intro: string[]; features: string[]; benefits: string[]; faq: { q: string; a: string }[] }> = {
  en: {
    h1: "OmniCure S2000 / S2000 Elite Lamps — 200 W UV Curing Lamp (012-64000R · 012-68000R)",
    intro: [
    ...
    faq: [
      ...
      { q: "Are these genuine OmniCure lamps with warranty?", a: "Yes — supplied through authorized channels; genuine lamps with full manufacturer warranty, not grey-market imports." },
  ...
  zh: {
    h1: "Omnicure S2000 / S2000 Elite 灯管 — 200W UV 固化灯管（012-64000R · 012-68000R）",
    intro: [
    ...
    faq: [
      ...
      { q: "是原厂正品 OmniCure 灯管并有保修吗?", a: "是——通过授权渠道供应 OmniCure 原厂正品灯管，并提供完整的原厂保修，绝非水货。" },
      { q: "有现货吗？交期多久?", a: "有——本地备货、快速发货，不会让您的产线停等备件。" },
    ],
  },
  th: {
    h1: "หลอด OmniCure S2000 / S2000 Elite — หลอดบ่มยูวี 200 วัตต์ (012-64000R · 012-68000R)",
    intro: [
    ...
    faq: [
      { q: "ควรเลือกหลอด S2000 รุ่นไหน — Standard หรือ Surface Cure?", a: "Standard (S2000 Elite 012-68000R · S2000 012-64000R) เหมาะกับงานบ่มกาวยูวีส่วนใหญ่ ส่วน Surface Cure (S2000 Elite 012-69000R · S2000 012-65000R) ปรับสเปกตรัมเพื่อผิวอะคริลิกเรียบเนียนไร้รอยต่อ ไม่แน่ใจ? ส่งลักษณะงานมาให้เรา แล้วเราจะช่วยยืนยันหมายเลขชิ้นส่วนที่ถูกต้อง" },
      ...
      { q: "เป็นหลอด OmniCure ของแท้พร้อมการรับประกันหรือไม่?", a: "ใช่ — ETIA จัดจำหน่ายผ่านช่องทางที่ได้รับอนุญาต หลอดของแท้พร้อมการรับประกันจากโรงงาน ไม่ใช่สินค้าหิ้ว" },
      { q: "มีสต็อกหลอด S2000 ในประเทศไทยหรือไม่?", a: "มี — สต็อกในพื้นที่และจัดส่งรวดเร็ว เพื่อไม่ให้สายการผลิตของคุณต้องรอ" },
    ],
  },
  vi: {
    h1: "Đèn Omnicure S2000 / S2000 Elite — Đèn UV 200W (012-64000R · 012-68000R)",
    intro: [
    ...
    faq: [
      { q: "Tôi nên chọn đèn S2000 nào — Standard hay Surface Cure?", a: "Standard (S2000 Elite 012-68000R · S2000 012-64000R) phù hợp với hầu hết ứng dụng dán keo UV. Surface Cure (S2000 Elite 012-69000R · S2000 012-65000R) định hình lại phổ để bề mặt acrylic liền mạch, không dính tay. Chưa chắc chắn? Hãy gửi ứng dụng của bạn cho chúng tôi, chúng tôi sẽ xác nhận đúng mã hàng." },
      ...
      { q: "Đây có phải đèn OmniCure chính hãng kèm bảo hành không?", a: "Đúng — cung cấp qua kênh được ủy quyền; đèn chính hãng với bảo hành đầy đủ từ nhà sản xuất, không phải hàng trôi nổi." },
...
const META: Record<LampLang, { title: string; description: string }> = {
  en: {
    title: "Omnicure S2000 / S2000 Elite Lamps | 012-64000R · 012-68000R",
    description:
      "Omnicure S2000 (012-64000R) and S2000 Elite (012-68000R) lamps: 200W high-pressure mercury UV spot source, 250–600nm, up to 40 W/cm². 2000h guaranteed, 4000h typical. Genuine, in stock in Thailand.",
  },
  zh: {
    title: "Omnicure S2000 / S2000 Elite 灯管 | 012-64000R · 012-68000R",
    description:
      "Omnicure S2000（012-64000R）与 S2000 Elite（012-68000R）灯管：200W 高压汞灯 UV 点光源，250–600nm，最高 40 W/cm²。保证 2000 小时寿命，典型可达 4000 小时。原厂正品，现货供应。",
  },
  th: {
    title: "หลอด OmniCure S2000 / S2000 Elite | 012-64000R · 012-68000R",
    description:
      "Omnicure S2000 (012-64000R) and S2000 Elite (012-68000R) lamps: 200W high-pressure mercury UV spot source, 250–600nm, up to 40 W/cm². 2000h guaranteed, 4000h typical. Genuine, in stock in Thailand.",
  },
  vi: {
    title: "Đèn Omnicure S2000 / S2000 Elite | 012-64000R · 012-68000R",
    description:
      "Đèn Omnicure S2000 (012-64000R) và S2000 Elite (012-68000R): nguồn UV điểm đèn thủy ngân áp suất cao 200W, 250–600nm, tới 40 W/cm². Bảo đảm 2000 giờ, thực tế ~4000 giờ. Hàng chính hãng.",
  },
};
