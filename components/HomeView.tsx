    ...
    <section className="relative overflow-hidden border-b border-[#D9E4EA] bg-gradient-to-br from-white via-[#EEF6FF] to-[#F1FAEF]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:py-24 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8">
        <div>
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-bold leading-[1.08] tracking-tight text-[#143C96] md:text-6xl">{t({ en: "Your UV Curing Solution Partner", zh: "您的UV 固化方案合作伙伴", th: "พันธมิตรโซลูชัน UV Curing ของคุณ", vi: "Đối tác giải pháp UV Curing của bạn" }, locale)}<span className="mt-2 block text-2xl font-bold text-[#41A62A] md:text-4xl">{t({ en: "From Selection to Support.", zh: "从选型到运维全程支持", th: "ตั้งแต่การเลือกจนถึงการดูแลรักษา", vi: "Từ lựa chọn đến hỗ trợ vận hành" }, locale)}</span></h1>
