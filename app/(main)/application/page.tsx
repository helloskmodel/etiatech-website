    ...
    <>
      ...
      <section className="py-16 md:py-20 relative overflow-hidden" style={{ background: "#0f2444" }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight mb-3">{t({ en: "Validated UV Curing Applications.", zh: "经过验证的 UV 光固化应用" }, locale)}<br /><span style={{ color: "#44B549" }}>{t({ en: "Reliable Performance.", zh: "可靠稳定的性能" }, locale)}</span></h1>
      ...
      <section id="case-studies" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl font-bold mb-3" style={{ color: "#1A56DB" }}>{t({ en: "From UV Curing Know-How to Real Results", zh: "从 UV 光固化专业积淀，到落地实效成果" }, locale)}</h2>
          <p className="text-gray-500 mb-10 max-w-3xl text-balance">{t({ en: "Unmatched UV curing expertise — full system solutions where chemistry, material, and equipment work as one.", zh: "积累丰富的UV光固化的经验—— 为客户制定融合耗材、胶粘剂与设备一体化解决方案。" }, locale)}</p>
