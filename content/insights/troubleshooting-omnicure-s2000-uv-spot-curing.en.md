...
If a fault persists after these checks — a red ring that won't clear, repeated failure to strike, or output you can't recover with recalibration — stop and get help rather than guessing. As the authorized OmniCure distributor in Thailand and Vietnam, ETIA provides troubleshooting, genuine replacement lamps and modules, R2000 calibration, and local service across Southeast Asia.
