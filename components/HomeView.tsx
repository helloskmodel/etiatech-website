...
export default function HomeView() {
  ...
  return <div className="bg-white text-[#102038]">
    ...
    <section className="px-4 pt-14 pb-10 sm:px-6 md:pt-20 lg:px-8"><div className="mx-auto max-w-7xl"><h2 className="text-3xl font-bold text-[#143C96] md:text-4xl">{t({ en: "Why Manufacturers Choose ETIA", zh: "为什么制造企业选择 ETIA", th: "ทำไมผู้ผลิตจึงเลือก ETIA", vi: "Vì sao các nhà sản xuất chọn ETIA" }, locale)}</h2>
