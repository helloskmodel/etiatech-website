...
const PROMISE = "Genuine Products Through Official Channels. Application-Driven Solutions. Local Supply Chain. Long-Term Service.";
    ...
    return (
      <div className="mt-4 border-t border-gray-200 pt-4">
        <div className="flex items-start gap-2">
          <BadgeCheck className="mt-0.5 shrink-0 text-[#41A62A]" size={17} aria-hidden="true" />
          <div>
    ...
    <section aria-labelledby="service-commitment-title" className="bg-white pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border border-[#1A56DB]/15 bg-[#f6f9ff] px-6 py-8 md:px-10 md:py-10">
          <div className="absolute inset-y-0 left-0 w-1.5 bg-[#41A62A]" aria-hidden="true" />
          <div className="flex flex-col gap-5 md:flex-row md:items-start">
            <BadgeCheck className="shrink-0 text-[#41A62A]" size={38} strokeWidth={1.8} aria-hidden="true" />
            <div>
              <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-[#41A62A]">Our Promise to Customers</p>
