...
const apps: App[] = [
  ...
  { id: "AN-PHO-001", industry: "Photonics & Advanced Packaging", subCategory: "Optical Transceiver", product: "LX500 V2 (365 nm)", title: "Optical Transceiver Assembly (400G/800G/1.6T)", hot: true, challenge: "High-speed pluggable optical transceivers (400G/800G/1.6T) require precise fiber-to-chip and lens attach with sub-micron alignment retention. Thermal epoxy cure introduces alignment drift and long cycle times that bottleneck high-volume datacom production.", solution: "Low-shrinkage UV-curable optical adhesive applied at fiber array, lens, and TOSA/ROSA interfaces. OmniCure LX500 V2 at 365 nm delivers 0 ms warm-up, controlled-dose cure with active alignment feedback maintained through cure. Near-zero-shrinkage formulation preserves coupling efficiency.", benefit: "Coupling-loss penalty <0.3 dB post-cure. Sub-micron alignment retention. Cure <8 s per joint vs. minutes for epoxy. Inline PLC integration for datacom transceiver volume production.", recommended: "OmniCure LX500 V2 (365 nm) + Active Alignment Integration" },
  { id: "AN-PHO-002", industry: "Photonics & Advanced Packaging", subCategory: "Photonic IC", product: "LX500 V2 or S2000 Elite", title: "Photonic IC (PIC) Packaging", hot: true, challenge: "Packaging photonic integrated circuits requires edge-coupling fiber arrays and attaching micro-optics to the PIC with index-matched adhesive, holding alignment within tens of nanometres while curing without inducing stress birefringence.", solution: "Index-matched UV-curable adhesive dispensed at the PIC edge-coupling interface. OmniCure LX500 V2 (365 nm) provides low-heat, tightly controlled dose; S2000 Elite available for thicker fixturing bonds. StepCure® ramp limits shrinkage stress during cure.", benefit: "Alignment retention <50 nm. Insertion-loss penalty minimized. No thermal drift via 0 ms warm-up. Repeatable dose via Intelli-Lamp® logging for process traceability.", recommended: "OmniCure LX500 V2 (365 nm) + StepCure® 2.0" },
  { id: "AN-PHO-003", industry: "Photonics & Advanced Packaging", subCategory: "Co-Packaged Optics", product: "LX500 V2 (365 nm)", title: "Co-Packaged Optics (CPO) Assembly", hot: true, challenge: "Co-packaged optics integrate optical engines adjacent to switch ASICs on a common substrate, demanding fiber attach and lid/lens bonding adhesives that cure fast at low temperature to protect the temperature-sensitive ASIC and substrate from CTE-mismatch stress.", solution: "Low-modulus UV-curable adhesive applied at fiber connector and optical engine interfaces. OmniCure LX500 V2 365 nm cures locally at the bond line with negligible heat to surrounding silicon. Spot-size adaptor confines the cure zone.", benefit: "Low-temperature, localized cure protects the ASIC and substrate. CTE stress minimized via low-modulus bond. Cure <10 s per joint. Compatible with high-density CPO assembly automation.", recommended: "OmniCure LX500 V2 (365 nm) + Spot Size Adaptor" },
  { id: "AN-PHO-004", industry: "Photonics & Advanced Packaging", subCategory: "Silicon Photonics", product: "AC Small (AC5) or LX500 V2", title: "Silicon Photonics Manufacturing", challenge: "Silicon photonics wafer- and die-level assembly requires UV cure of grating-coupler fiber attach, micro-lens bonding, and underfill at fine pitch, with uniform dose across the die and no contamination of optical surfaces.", solution: "UV-curable optical adhesive and snap-cure underfill applied at silicon photonics interfaces. OmniCure AC Small area system delivers uniform irradiance across the die; LX500 V2 spot handles localized fiber attach. Tight dose control prevents over-cure of nearby waveguides.", benefit: "Uniform die-level cure. Snap-cure underfill replaces the oven step. Optical surfaces kept contamination-free. Throughput matched to silicon photonics die-attach lines.", recommended: "OmniCure AC Small (AC5) or LX500 V2 (365 nm)" },
  { id: "AN-PHO-005", industry: "Photonics & Advanced Packaging", subCategory: "LiDAR Sensor", product: "S2000 Elite or LX500 V2", title: "LiDAR Sensor Assembly", hot: true, challenge: "Automotive and industrial LiDAR modules require bonding of laser emitters (VCSEL/EEL), micro-optics, and receiver arrays with precise alignment and AEC-Q environmental durability, replacing slow thermal cure that drifts alignment.", solution: "UV-curable optical and structural adhesive applied at emitter, lens, and detector interfaces. OmniCure S2000 Elite (broad-spectrum) or LX500 V2 (365 nm) cures rapidly with CLF dose consistency. Active alignment maintained during cure.", benefit: "Optical alignment retained through cure. AEC-Q200 thermal-shock-durable bond. Cure <10 s. NIST-traceable dose records via R2000 for automotive quality compliance.", recommended: "OmniCure S2000 Elite or LX500 V2 + R2000 Radiometer" },
  { id: "AN-PHO-006", industry: "Photonics & Advanced Packaging", subCategory: "Advanced Packaging", product: "S2000 Elite or LX500 V2", title: "Advanced Semiconductor Packaging (Chiplet / 2.5D / 3D)", hot: true, challenge: "Advanced packaging (chiplet, 2.5D interposer, 3D stacked die) requires snap-cure UV underfill, die-attach tacking, and lid/stiffener bonding that flows at fine bump pitch and cures rapidly without thermal exposure that warps thin interposers.", solution: "Snap-cure UV underfill and structural adhesive dispensed around the chiplet/interposer perimeter. OmniCure S2000 Elite or LX500 V2 delivers a defined dose to initiate snap-cure; StepCure® ramp controls exotherm to prevent warpage of thin dies.", benefit: "Snap cure eliminates long oven cycles. Fine-pitch capillary underfill voids <0.1%. Thin-interposer warpage minimized. Throughput increased vs. thermal underfill for 2.5D/3D assembly.", recommended: "OmniCure S2000 Elite or LX500 V2 + StepCure® 2.0" },
];
            ...
            {successStories.map((s) => (
              ...
              >
                ...
                <div className="relative h-32 overflow-hidden bg-gray-100">
                  {industryImage[s.industry] ? (
                    <img src={industryImage[s.industry]} alt={s.industry} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  ) : (
        ...
        >
          ...
          >
            ...
            <div className="relative h-36 overflow-hidden rounded-t-2xl bg-gray-100">
              {industryImage[selectedCase.industry] ? (
                <img src={industryImage[selectedCase.industry]} alt={selectedCase.industry} className="w-full h-full object-cover" />
              ) : (
