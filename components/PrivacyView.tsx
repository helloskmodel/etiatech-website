      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-600 text-sm leading-relaxed space-y-8">
          ...
          <Section title={{ en: "4. How We Share Information", zh: "4. 我们如何共享信息", th: "4. เราเปิดเผยข้อมูลอย่างไร", vi: "4. Cách Chúng tôi Chia sẻ Thông tin" }} locale={locale}>
            ...
            {/* The group companies are separate legal persons, so passing an
                enquiry to the one that serves the customer's market is a
                disclosure to a third party — Thailand's PDPA and Vietnam's
                Decree 13/2023 both require the recipient to be named. */}
            <p className="mt-2">{t({ en: "ETIA Technology is a group of separately incorporated companies. When your enquiry concerns a market served by another group company, we pass it to that company so it can answer you, quote, deliver and provide service. Those companies are ETIATECH (THAILAND) Co., Ltd. (Thailand) and ETIA-TECH VIET NAM Co., Ltd. (Vietnam). They use your information only to respond to your enquiry and to perform the resulting sale and service.", zh: "ETIA Technology 由数家独立注册的公司组成。当您的咨询涉及由集团内其他公司服务的市场时，我们会将其转交该公司，以便其答复、报价、交付与提供服务。这些公司为 ETIATECH (THAILAND) Co., Ltd.（泰国）与 ETIA-TECH VIET NAM Co., Ltd.（越南）。它们仅将您的信息用于答复您的咨询以及履行由此产生的销售与服务。", th: "ETIA Technology ประกอบด้วยบริษัทที่จดทะเบียนแยกจากกันหลายแห่ง เมื่อคำสอบถามของท่านเกี่ยวข้องกับตลาดที่บริษัทอื่นในกลุ่มดูแลอยู่ เราจะส่งต่อคำสอบถามนั้นให้บริษัทดังกล่าวเพื่อตอบกลับ เสนอราคา ส่งมอบ และให้บริการแก่ท่าน บริษัทเหล่านั้นได้แก่ บริษัท อีเทียเทค (ไทยแลนด์) จำกัด (ประเทศไทย) และ ETIA-TECH VIET NAM Co., Ltd. (เวียดนาม) บริษัทเหล่านี้ใช้ข้อมูลของท่านเพียงเพื่อตอบคำสอบถามและเพื่อดำเนินการขายและให้บริการที่เกิดขึ้นตามมาเท่านั้น", vi: "ETIA Technology gồm nhiều công ty được thành lập độc lập. Khi yêu cầu của bạn liên quan đến thị trường do một công ty khác trong tập đoàn phụ trách, chúng tôi chuyển yêu cầu đó cho công ty ấy để họ phản hồi, báo giá, giao hàng và cung cấp dịch vụ. Các công ty đó là ETIATECH (THAILAND) Co., Ltd. (Thái Lan) và CÔNG TY TNHH ETIA-TECH VIỆT NAM (Việt Nam). Họ chỉ sử dụng thông tin của bạn để phản hồi yêu cầu và để thực hiện việc bán hàng, dịch vụ phát sinh từ đó." }, locale)}</p>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li>{t({ en: "WhatsApp, LINE and Zalo — only if you choose to contact us through them; their own privacy policies then apply.", zh: "WhatsApp、LINE 与 Zalo——仅当您选择通过它们联系我们时使用，届时适用其各自的隐私政策。", th: "WhatsApp, LINE และ Zalo — เฉพาะเมื่อท่านเลือกติดต่อเราผ่านช่องทางเหล่านี้ ซึ่งจะอยู่ภายใต้นโยบายความเป็นส่วนตัวของผู้ให้บริการนั้น", vi: "WhatsApp, LINE và Zalo — chỉ khi bạn chọn liên hệ với chúng tôi qua các kênh này; khi đó chính sách bảo mật của họ được áp dụng." }, locale)}</li>
            </ul>
</Section>
