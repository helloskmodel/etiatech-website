      ...
      <section className="relative overflow-hidden border-b border-[#D9E4EA] bg-gradient-to-br from-white via-[#EEF6FF] to-[#F1FAEF] py-16 md:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-6 max-w-3xl text-4xl font-bold leading-[1.08] tracking-tight text-[#143C96] md:text-6xl">
            {t({ en: "UV Curing Insights", zh: "UV Curing 紫外线固化洞察", th: "ข้อมูลเชิงลึก UV Curing", vi: "Thông tin chuyên sâu UV Curing" }, locale)}<span className="mt-2 block text-2xl font-bold text-[#41A62A] md:text-4xl">{t({ en: "& Application Guides", zh: "和应用指南", th: "และคู่มือการใช้งาน", vi: "& Hướng dẫn ứng dụng" }, locale)}</span>
          </h1>
