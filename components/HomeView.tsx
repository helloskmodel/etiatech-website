...
const whyCards: { title: LangText; body: LangText; icon: ComponentType<{ className?: string; strokeWidth?: number }> }[] = [
  { title: { en: "20 Years of Application Experience", zh: "20 年应用经验", th: "ประสบการณ์ด้านการใช้งาน 20 ปี" }, body: { en: "Hands-on UV curing knowledge across medical, electronics, photonics, automotive and industrial manufacturing.", zh: "覆盖医疗、电子、光子、汽车及工业制造领域的 UV Curing 光固化实战经验。", th: "ความรู้ด้าน UV curing เชิงปฏิบัติในอุตสาหกรรมการแพทย์ อิเล็กทรอนิกส์ โฟโตนิกส์ ยานยนต์ และการผลิตทางอุตสาหกรรม" }, icon: GraduationCap },
    ...
    <section className="relative overflow-hidden border-b border-[#D9E4EA] bg-gradient-to-br from-white via-[#EEF6FF] to-[#F1FAEF]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:py-24 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8">
        <div>
          ...
          <h1 className="mt-6 max-w-4xl text-4xl font-bold leading-[1.08] tracking-tight text-[#143C96] md:text-6xl">{t({ en: "Your UV Curing Solution Partner", zh: "您的 UV Curing 光固化解决方案伙伴", th: "พันธมิตรโซลูชัน UV Curing ของคุณ", vi: "Đối tác giải pháp UV Curing của bạn" }, locale)}<span className="mt-2 block text-2xl font-bold text-[#41A62A] md:text-4xl">{t({ en: "From Selection to Support.", zh: "从选型到支持", th: "ตั้งแต่การเลือกจนถึงการดูแลรักษา", vi: "Từ lựa chọn đến hỗ trợ vận hành" }, locale)}</span></h1>
