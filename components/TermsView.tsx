      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-600 text-sm leading-relaxed space-y-8">
          ...
          <Section title={{ en: "4. Authorized Distributor & Warranties", zh: "4. 授权代理与保修", th: "4. ตัวแทนจำหน่ายที่ได้รับอนุญาตและการรับประกัน", vi: "4. Nhà Phân phối Được Ủy quyền & Bảo hành" }} locale={locale}>
            <p>{t({ en: "ETIA is an authorized distributor of the products presented on this website. Product warranties, where applicable, are provided by the respective manufacturers in accordance with their own terms. Nothing on this website constitutes a warranty by ETIA beyond what is expressly agreed in a written sales contract.", zh: "ETIA 是本网站所示产品的授权代理商。适用的产品保修由各原厂制造商按其自身条款提供。除书面销售合同中明确约定者外，本网站的任何内容均不构成 ETIA 的保证。", th: "ETIA เป็นตัวแทนจำหน่ายที่ได้รับอนุญาตของผลิตภัณฑ์ที่นำเสนอบนเว็บไซต์นี้ การรับประกันผลิตภัณฑ์ (หากมี) จัดให้โดยผู้ผลิตแต่ละรายตามข้อกำหนดของผู้ผลิตนั้น ๆ ไม่มีสิ่งใดบนเว็บไซต์นี้ที่ถือเป็นการรับประกันโดย ETIA นอกเหนือจากที่ได้ตกลงกันไว้อย่างชัดแจ้งในสัญญาการขายที่เป็นลายลักษณ์อักษร", vi: "ETIA là nhà phân phối được ủy quyền của các sản phẩm được giới thiệu trên trang web này. Bảo hành sản phẩm, nếu có, do các nhà sản xuất tương ứng cung cấp theo các điều khoản riêng của họ. Không có nội dung nào trên trang web này cấu thành một cam kết bảo hành của ETIA ngoài những gì đã được thỏa thuận rõ ràng trong hợp đồng mua bán bằng văn bản." }, locale)}</p>
          </Section>
