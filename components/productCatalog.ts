...
export const products: Product[] = [
  ...
  },
  {
    ...
    intro:
      "From simple regulators to fully integrated PLC-based automation, in all power ranges — the control side of an infrared installation, where the difference between heating and process control actually lies.",
    features: [
      "Infinitely variable power output with zero-wear, low-loss semiconductor power boards",
      "Power-setting methods matched to the process",
      "Setpoint entry by potentiometer, regulator or external signal",
      "Interfacing by contacts, analog signals or modern fieldbus systems",
      "Robust housing for harsh industrial environments, with high protection and electrical safety",
      "Contact breakers or fuses protect emitter connections",
      "Emergency stop isolating the load from the mains supply",
      "Fault detection and reporting for emitter, load fuse, load board or load voltage failure",
      "Automatic control of module ventilation and emitter temperature monitoring",
      "Industry-standard regulators — nominal/actual display, timers, ramp and limit functions, PID self-optimisation, manual/automatic test",
    ],
    applications: [
